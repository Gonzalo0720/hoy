...
showFuelbar(){
push();
//image( fuelImage, width/2-130, heiight-player.positionY-100, 20, 20);
fill("white");
...
gameOver(){
  ...
  text: "Te tardaste",
  imageUrl:
  "//cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
  imageSize: "100x100",
  confirmButtonText: "ni modo"
});
}
}